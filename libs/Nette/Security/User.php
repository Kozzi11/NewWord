...
class User extends Nette\Object
{
    ...
    {
	return $this->saveUserToDatabase($fristname, $surname, $emailAdress, $password, $role);	
    }

    private function saveUserToDatabase($fristname, $surname, $emailAdress, $password, $role)
    {
	...
	$data = array($emailAdress => $emailAdress,
		      $fristname   => $fristname,
		      $surname     => $surname,
		      $password    => $password,
		      $role        => $role
	...
	{
	    return $this->getIdentity()->data['emailAdress'];
	}
